...
class EstimatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estimate" do
    assert_difference('Estimate.count') do
      post estimates_url, params: { estimate: { description: @estimate.description, issue: @estimate.issue, other: @estimate.other, pdf: @estimate.pdf, tipo: @estimate.tipo, username: @estimate.username } }
    end
  ...
  test "should update estimate" do
    patch estimate_url(@estimate), params: { estimate: { description: @estimate.description, issue: @estimate.issue, other: @estimate.other, pdf: @estimate.pdf, tipo: @estimate.tipo, username: @estimate.username } }
