...
class AssistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assistance" do
    assert_difference('Assistance.count') do
      post assistances_url, params: { assistance: { chat: @assistance.chat, state: @assistance.state, username: @assistance.username } }
    end
  ...
  test "should update assistance" do
    patch assistance_url(@assistance), params: { assistance: { chat: @assistance.chat, state: @assistance.state, username: @assistance.username } }
