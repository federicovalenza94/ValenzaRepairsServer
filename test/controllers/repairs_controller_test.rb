...
class RepairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post repairs_url, params: { repair: { date: @repair.date, description: @repair.description, device: @repair.device, price: @repair.price, username: @repair.username } }
    end
  ...
  test "should update repair" do
    patch repair_url(@repair), params: { repair: { date: @repair.date, description: @repair.description, device: @repair.device, price: @repair.price, username: @repair.username } }
